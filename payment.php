        ...
        <form action="ticket.php" method="post">
            ...
            <div class="input-group">
                <div class="input-box">
                    ...
                    <label for="bc1"><span><i class="fa fa-cc-visa"></i> BLIK</span></label>

                    <input type="radio" name="pay" id="bc2" class="radio">
                    <label for="bc2"><span><i class="fa fa-cc-paypal"></i> karta płatnicza</span></label>

                    <input type="radio" name="pay" id="bc3" class="radio">
                    <label for="bc3"><span><i class="fa fa-cc-visa"></i> szybki przelew</span></label>
